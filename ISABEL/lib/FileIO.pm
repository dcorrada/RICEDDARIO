package ISABEL::lib::FileIO;

use Cwd;
use base ( 'ISABEL::lib::Generic_class' ); # eredito la classe generica contenente il costruttore, l'AUTOLOAD ecc..
use Carp;
our $AUTOLOAD;
...
# Unisco gli attributi della classe madre ISABEL::lib::Generic_class e della classe figlia
my $ref = ISABEL::lib::Generic_class::_hash_joiner(\%ISABEL::lib::Generic_class::_attribute_properties, \%_attribute_properties);
...
=head1 ISABEL::lib::FileIO

FileIO: classe per la gestione di files

=head1 Synopsis

    use ISABEL::lib::FileIO;

    my $file_obj = ISABEL::lib::FileIO->new();
