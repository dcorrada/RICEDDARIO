...
#######################
## VARIABILI GLOBALI ##
our $maq_bins_path = ($options{e})? $options{e} : '/analysis_home/dcorrada/bin/'; # path dei file binari di maq
...
our $maps_threads = 8;#4;   # massimo numero di threads che girano contemporaneamente nello STEP 2
...
my $thread_mon_params = { user => 'dcorrada', sleep => '1800' };# tempo (sec) e utente su cui monitorare i processi
