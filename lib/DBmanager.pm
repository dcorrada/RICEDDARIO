package RICEDDARIO::lib::DBmanager;
...
# Unisco gli attributi della classe madre RICEDDARIO::lib::Generic_class e della classe figlia
...
RICEDDARIO::lib::Generic_class::_hash_joiner(\%RICEDDARIO::lib::FileIO::_attribute_properties, \%_attribute_properties);
%_attribute_properties = %$ref;
...
=head1 RICEDDARIO::lib::DBmanager

DBmanager - classe generica per la gestione di database

=head1 SYNOPSIS

    use RICEDDARIO::lib::DBmanager;
    
    # instanzio un nuovo oggetto
    my $obj = RICEDDARIO::lib::DBmanager->new('user' => 'foo', 'password' => 'barbaz');
