package BRENDA::lib::Generic_class;
...
=head1 BRENDA::lib::Generic_class
...
=head1 Synopsis
    ...
    # eredito la classe
    use base ( 'BRENDA::lib::Generic_class' );
    ...
    # Unisco gli attributi della classe madre BRENDA::lib::Generic_class e della classe figlia
