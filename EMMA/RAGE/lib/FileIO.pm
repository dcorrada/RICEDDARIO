...
###################################################################
use Cwd;
use base ( 'RAGE::lib::Generic_class' ); # eredito la classe generica contenente il costruttore, l'AUTOLOAD ecc..
use Carp;
our $AUTOLOAD;
...
# Unisco gli attributi della classe madre RAGE::lib::Generic_class e della classe figlia
my $ref = RAGE::lib::Generic_class::_hash_joiner(\%RAGE::lib::Generic_class::_attribute_properties, \%_attribute_properties);
...
=head1 Synopsis
    ...
    my $file_obj = RAGE::lib::FileIO->new();
