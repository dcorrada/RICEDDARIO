...
our $paths = { # path dove risiedono i file fastA/Q
               fasta => '/home/korda/test_maq/ref_files',
               fastq => '/home/korda/test_maq/fastaq_files' };

our $file_list = { # lista dei nomi dei file fastA/Q
               fasta => [ 'Hs.AllGenome.fa',
                          'mrna.fa' ],
               fastq => [ 'K562_single_rep1.lane1.fastq',
                          'K562_single_rep1.lane2.fastq.gz',
                          'K562_single_rep1.lane3.fastq.gz',
                          'K562_single_rep1.lane4.fastq.gz' ] };

our $working_dir = '/home/korda/test_maq'; # path di output

our $maq_pipeline = '/home/dcorrada/maq_pipeline.pl'; # path dello script maq_pipeline.pl
